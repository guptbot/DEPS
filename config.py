...
def parse_arguments():
    ...
    parser.add_argument('--dataset_folder', dest='dataset_folder', type=str, default="mw_2500_ds")
    ...
    parser.add_argument('--metaworld_test_set', dest='metaworld_test_set', type=str, default="mw-vanilla")
    # Param Skill args
    ...
    parser.add_argument('--mask_z_to_var', dest='mask_z_to_var', type=int, default=0)
    ...
    parser.add_argument('--mask_robot_state', dest='mask_robot_state', type=int, default=0)


    # Env args
    parser.add_argument('--state_dim', dest='state_dim', type=int, default=72)
    parser.add_argument('--robot_state_dim', dest='robot_state_dim', type=int, default=8)
    parser.add_argument('--action_dim', dest='action_dim', type=int, default=4)
    parser.add_argument('--traj_length', dest='traj_length', type=int, default=429) #340) #517)#388)#373)
    parser.add_argument('--input_size', dest='input_size', type=int, default=76)
    parser.add_argument('--language_dim', dest='language_dim', type=int, default=50)
    ...
    parser.add_argument('--few_shot_finetune', dest='few_shot_finetune', type=int, default=0)
    parser.add_argument('--use_corrected_action', dest='use_corrected_action', type=int, default=1)
    parser.add_argument('--rollout_trajectories_start_idx', dest='rollout_trajectories_start_idx', type=int, default=0)
    parser.add_argument('--rollout_trajectories_end_idx', dest='rollout_trajectories_end_idx', type=int, default=50)
